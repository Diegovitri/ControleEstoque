...
CREATE TABLE IF NOT EXISTS `controleestoque`.`alocacao_de_material` (
  ...
  PRIMARY KEY (`cd_material`, `cd_obra`),
  INDEX `fk_alocacao_de_material_tb_obra1_idx` (`cd_obra` ASC),
  CONSTRAINT `fk_alocacao_de_material_tb_material1`
    FOREIGN KEY (`cd_material`)
    REFERENCES `controleestoque`.`tb_material` (`cd_material`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_alocacao_de_material_tb_obra1`
    FOREIGN KEY (`cd_obra`)
