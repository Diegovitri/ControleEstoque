...
CREATE TABLE IF NOT EXISTS `controleestoque`.`tb_obra` (
  ...
  PRIMARY KEY (`cd_obra`),
  INDEX `fk_tb_obra_almoxarifado1_idx` (`cd_almoxarifado` ASC),
  CONSTRAINT `fk_tb_obra_almoxarifado1`
...
CREATE TABLE IF NOT EXISTS `controleestoque`.`tb_construtora` (
  ...
  INDEX `fk_tb_construtora_tb_obra1_idx` (`cd_obra` ASC),
  CONSTRAINT `fk_tb_construtora_tb_obra1`
    FOREIGN KEY (`cd_obra`)
